...
pub(crate) const DEFAULT_ENCODING_PRESET: u8 = 6;
pub(crate) const DEFAULT_MAX_ENCODED_PERCENT_BASIS_POINTS: u32 = 8_000;
pub(crate) const DEFAULT_SAMPLE_DURATION_MS: u64 = 20_000;
...
/// drift.
pub(crate) const IMPORT_MTIME_TOLERANCE_NS: u64 = 1_000_000_000;
