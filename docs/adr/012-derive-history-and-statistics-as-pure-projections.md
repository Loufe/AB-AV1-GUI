...
Superseded in full by ADR-015, project imported history separately, which retains this record's pure-projection, ephemeral-Statistics, and Rust-oracle with TypeScript-fixture decisions. Cite ADR-015, not this record, for anything still live.

See issue #40 (requirements), #39 (parked records), `docs/TESTING.md` (the
mirror-and-fixtures contract), ADR-002, ADR-004, ADR-006.
