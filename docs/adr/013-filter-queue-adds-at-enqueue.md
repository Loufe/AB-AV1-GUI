...
Implemented across issue #41. The command surface these rules ride on, including why bulk edits are frontend loops over per-item commands rather than one bulk command, is in `docs/design/event-stream.md`.
