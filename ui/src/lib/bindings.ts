...
export const commands = {
	...
	subscribe: (channel: Channel<ShellEvent>) => typedError<null, CommandError>(__TAURI_INVOKE("subscribe", { channel })),
...
export type StreamPayload = ({ Snapshot: DurableState }) & { Degraded?: never; Durable?: never; EngineFatal?: never; Ephemeral?: never } | ({ Durable: DurableDelta }) & { Degraded?: never; EngineFatal?: never; Ephemeral?: never; Snapshot?: never } | ({ Ephemeral: EphemeralDelta }) & { Degraded?: never; Durable?: never; EngineFatal?: never; Snapshot?: never } | ({ Degraded: {
	reason: string,
